...
function initSearch() {
  ...
  request.open('GET', 'https://reclaimthewild.github.io/rebuild-en/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://reclaimthewild.github.io/rebuild-en/assets/css/just-the-docs-' + theme + '.css');
}
